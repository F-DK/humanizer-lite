...
- `references/patterns.md` — the canonical, numbered pattern list (1-33) with watchlists and before/after examples. **This is the source of truth for pattern content.**
...
- **Patterns:** the skill currently defines **33 numbered patterns**, in `references/patterns.md`. If you add, remove, or renumber any, update the README pattern table, its "N Patterns Detected" heading, and every cross-reference in the same change. Keep numbering stable unless you are deliberately renumbering.
